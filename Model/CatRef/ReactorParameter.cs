...
{
    [Display(Name = "Характеристики реакторов")]
    public partial class ReactorParameter
    {
        ...
        [Display(Name = "Реактор")]
        [Required(ErrorMessage = "Укажите реактор")]
        public short ReactorId { get; set; }
        ...
        [Browsable(false)]
        public virtual Reactor Reactor { get; set; } = null!;
